...
4. **Data Updates:** If the data structure changes, ensure you update `generate_data.py` and run it to regenerate the `books.json` and `cross_references.txt` artifacts.
